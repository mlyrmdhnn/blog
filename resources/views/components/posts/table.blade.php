...
@endif
                <div class="w-full md:w-auto flex flex-col md:flex-row space-y-2 md:space-y-0 items-stretch md:items-center justify-end md:space-x-3 flex-shrink-0">
                    <a href="/dashboard/create" class="flex items-center justify-center text-white bg-[#1d4ed8] hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-primary-600 dark:hover:bg-[#1d4ed8] focus:outline-none dark:focus:ring-primary-800">
                    ...
                    <tbody>
                        ...
                        <tr class="border-b dark:border-gray-700">
                            ...
                            <td class="px-4 py-3 flex items-center justify-end">
                                <button id="{{ $post->id }}-dropdown-button" data-dropdown-toggle="{{ $post->id }}-dropdown" class="inline-flex items-center text-sm font-medium hover:bg-gray-100 dark:hover:bg-gray-700 p-1.5 dark:hover-bg-gray-800 text-center text-gray-500 hover:text-gray-800 rounded-lg focus:outline-none dark:text-gray-400 dark:hover:text-gray-100" type="button">
                                ...
                                <div id="{{ $post->id }}-dropdown" class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
                                    <ul class="py-1 text-sm" aria-labelledby="{{ $post->id }}-dropdown-button">
                                        <li>
                                            <a href="/dashboard/{{ $post->slug }}/edit" data-modal-target="updateProductModall" data-modal-toggle="updateProductModall" class="flex w-full items-center py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white text-gray-700 dark:text-gray-200">
                                        ...
                                        <li>
                                            <a href="/dashboard/{{ $post->slug }}" data-modal-target="readProductModall" data-modal-toggle="readProductModall" class="flex w-full items-center py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white text-gray-700 dark:text-gray-200">
                                                <svg class="w-4 h-4 mr-2" xmlns="http://www.w3.org/2000/svg" viewbox="0 0 20 20" fill="currentColor" aria-hidden="true">
                                        ...
                                        <li>
                                            <button type="button" data-modal-target="deleteModal-{{ $post->id }}" data-modal-toggle="deleteModal-{{ $post->id }}" class="flex w-full items-center py-2 px-4 hover:bg-gray-100 cursor-pointer dark:hover:bg-gray-600 text-red-500 dark:hover:text-red-400">
