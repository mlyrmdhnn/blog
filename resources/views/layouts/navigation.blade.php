                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <div class="flex items-center px-5">
                            <div class="shrink-0">
                              <img  src="{{ Auth::user()->avatar ? asset('storage/' . Auth::user()->avatar) :  asset('img/default.jpg') }}" alt="{{ Auth::user()->name }}" alt="{{ Auth::user()->avatar }}" class="size-10 rounded-full outline -outline-offset-1 outline-white/10" />
                            </div>
